...
export function Card({ imageUrl, title, description, color = "red" }: Props) {
  return (
    <figure className="bg-[#181818] hover:bg-[#282828] rounded-lg overflow-hidden p-4 cursor-pointer transition-all group/card">
